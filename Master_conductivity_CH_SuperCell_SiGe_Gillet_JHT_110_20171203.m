...
% % % C = 137.3; % unit: K. 
% % % D = 1.32e-45; % s^3. % % % N = 30; 
Nk = 30; % 20; % 50; % 30; %  % 30; %50; %120; % 120; %    50; %    80; % 30; %  60; %80; %   30; % 120; % 50; %[80]; % 30; %  [10, 20, 30, 40, 50, 80, 100]; % ]; %      
...
% % %     ksumx2(nk) = ksum2;
   ...
   %  Uprocess_scat_inv = bu*(wwmode.*wwmode)./(vmode.*vmode);
    ...
    Uprocess_scat_inv = (h*gru^2*T/massSi/theta*exp(-theta/3/T))*(wwmode.*wwmode)./(vmode.*vmode);
