...
Nk = 120; % 120; %80; % 60; %     80; %20; % 100; % 16; %40; %   [60]; %   
...
Ptotal = 1; % 400; % 450; % 80; % % 
Pendflag = 1:Ptotal; % [225:234]; % [386:Ptotal]; % [352:Ptotal]; % [1:Ptotal]; % 
...
%     cd('C:\ww_vv_Calculation_BulkGe');
    fname31 = sprintf('ww_BulkGe%d_Nk_%d_P%d_%d.csv', ncx, N, Pn(end),Ptotal);
    save(fname31,'ww','-ascii');
    fname32 = sprintf('vv_BulkGe%d_Nk_%d_P%d_%d.csv', ncx, N, Pn(end),Ptotal);
