...
Nk = 80; % 120; % 30; % 120; %80; % 60; %     80; %20; % 100; % 16; %40; %   [60]; %   
...
Ptotal = 80; % 120; % 450; % 80; % % 
Pendflag = [33:36,40:42]; % 70; % 15:17; % [33:40]; %[41:42,56:70]; %[47:51]; %[29:42]; %[14:17]; %[56:70]; %[26:35]; %[25:-1:1]; % [1:Ptotal]; % TMC62-05: 81:95; % 
