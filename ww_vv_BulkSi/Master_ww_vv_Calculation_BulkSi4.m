...
Ptotal = 200; % 80; % % 
Pendflag = [151:156]; % [157:160]; %VPC-05: 151:160; % VPC-18: 141:150; % VPC-14: 91:100; % VPC-09:61:70; % VPC-20:51:60; %  VPC-10: 31:40; % VPC-03 : 21:30; % VPC-26: 11:20; 
% VPC-05: 101:110; % VPC-18: 111:120; % VPC-07: 191:200; %  VPC-09: 181:190; % VPC-02:31-40,VPC-20:171:180; %  VPC-10:161:170; % VPC-15:21:30,151:160 % VPC-28: 141:150; % VPC-30: 131:140; % VPC-26: 121:130; % VPC-19: 111:120; % VPC-22: 101:110; % VPC-11: 91:100; % VPC-14: 81:90; % VPC-03:71:80; %  VPC-21: 61:70; %  VPC-25:51-60. 
% VPC-24:1-10; VPC-12: 11-20; VPC-15:21-30. vpc-02:31-40. VPC-16:41:50
...
%       fprintf(fileID,'%6d %12.8f %12.8f %12.8f %12.8f %12.8f\n', nk, Cpsumnk(nk),ksumx2(nk), ksumx_NBS(nk), ksumx_3Part(nk),ksumx_4Gillet(nk));
    ...
    fname31 = sprintf('ww_BulkSi%d_Nk_%d_P%d_%d.csv', ncx, N, Pn(end),Ptotal);
    save(fname31,'ww','-ascii');
    fname32 = sprintf('vv_BulkSi%d_Nk_%d_P%d_%d.csv', ncx, N, Pn(end),Ptotal);
