...
Ptotal = 120; % 125; % 80; % 20; % 
Pendflag = 120; % [70]; % [28]; % [29]; % [30];%[60,11]; % [75:76]; % [77:78]; % [79:80]; % [72:80]; % [57:60]; % [47:50]; % [37:40]; % [27:30]; % [17:20]; % [7:10]; %[12:20]; % [31:40];% [51:60]; % [71:80]; % [21:40]; % [41:60]; % [61:80]; % 1:Ptotal; % 116:125; % ; % 10:14; % 15:17; % 5:17; %20; %  19:20; % 48:55; % 23:35; % 86:95; % 76:85; % 66:75; % 56:65; % 46:55; % 36:45; % 21:35; % 6:10; % 1:5; % 3:10; % 18:Ptotal; % 14:17; % 11:13;  % 1:10; % Ptotal; % 4:8; % 9:10; % 11:15; % 16:Ptotal; 
