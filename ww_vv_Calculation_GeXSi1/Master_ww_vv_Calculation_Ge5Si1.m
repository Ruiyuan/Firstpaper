...
Nk = 30; % 50; % 120; %80; % 60; %     80; %20; % 100; % 16; %40; %   [60]; %   
...
Ptotal = 900; % 200; % 80; % % 
Pendflag = [75]; % [697:698]; % [194:195]; % [164:165]; % [179:180];% 288:289]; % [134:135]; % [143:146]; % [148,150];%[661,76:80]; %[276:289,661,76:80]; % [196:200,690:700]; % [181:195]; % [166:180]; % [151:165]; %[136:140];%[121:135]; % [61:75];% [61:80,121:200,276:289,661,690:700];% [629:630,637:645,652:660]; %]; % [799:800,499:500,400,652:660,606:610,614:615,622:630,637:645,652:660]; % [101:120]; % [81:100]; % [61:80]; % [41:60]; % [21:40];
...
%     cd('C:\Users\ruiyma\');
    fname31 = sprintf('ww_Ge%dSi1_Nk_%d_P%d_%d.csv', ncx, N, Pn(end),Ptotal);
    save(fname31,'ww','-ascii');
    fname32 = sprintf('vv_Ge%dSi1_Nk_%d_P%d_%d.csv', ncx, N, Pn(end),Ptotal);
